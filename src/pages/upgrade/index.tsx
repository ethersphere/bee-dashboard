...
import { createGiftWallet, restartBeeNode, upgradeToLightNode } from '../../utils/desktop'
...
export default function Upgrade(): ReactElement {
  const { giftWallets, addGiftWallet, provider, providerUrl } = useContext(TopUpContext)
